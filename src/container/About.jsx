    ...
    <>
     <div className="hero">
		...
		<div className="untree_co-section">
            ...
            <p className="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					</div> 
					...
					<div className="col-lg-12">
						<div className="testimonial-slider-wrap text-center">
							...
							<div id="testimonial-nav">
								<span className="prev" data-controls="prev"><span class="fa fa-chevron-left"></span></span>
								<span className="next" data-controls="next"><span class="fa fa-chevron-right"></span></span>
							</div>
